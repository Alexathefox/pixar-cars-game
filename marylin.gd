...
@export var engine_power = 800  # How much force the engine can apply for acceleration
@export var friction = -100  # The friction coefficient that slows down the car
